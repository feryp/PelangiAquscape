...
public class GrafikKeuntunganTahunActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner = findViewById(R.id.spinner_tahun);
        ...
        BarDataSet barDataSet = new BarDataSet(barEntries, "Total Keuntungan");
        ...
        description.setText("Total Keuntungan Per-Bulan");
