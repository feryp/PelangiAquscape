            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (week == 1) {
                        switch (week) {
                            case 0:
                                minggu1 = minggu1 + penjualan.getTotalPenjualan();
                                break;
                            case 1:
                                minggu2 = minggu2 + penjualan.getTotalPenjualan();
                                break;
                            case 2:
                                minggu3 = minggu3 + penjualan.getTotalPenjualan();
                                break;
                            case 3:
                                minggu4 = minggu4 + penjualan.getTotalPenjualan();
                                break;
                        }
